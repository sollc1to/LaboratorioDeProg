...
/* No lo pude hacer andar pero iria en login y registrar para generar la cookie y redirigir al home
const meterToken = (req, res, userData) => {
    const token = jwt.sign(userData, process.env.SECRET_JWT_KEY, {
        expiresIn: '1h'
    });
